# A mixin describes a module that we inject into a class to add additional behavior. It's a way
# to share functionality between classes without declaring a superclass/subclass hierarchy.
...
fridge = Refrigerator.new(
  snacks: ["Doritos", "Jolly Ranchers", "Ben & Jerry's"],
